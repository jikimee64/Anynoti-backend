...
import com.anynoti.config.AuthServiceConfig;
import com.anynoti.config.custom.PropertiesConfiguration;
...
@Import({HttpEncodingAutoConfiguration.class, AuthServiceConfig.class}) //한글깨짐 방지
